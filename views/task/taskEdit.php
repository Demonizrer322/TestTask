<form method="POST" class="d-flex flex-column align-items-center mt-5">
    <input class="w-25 mb-1" name="Name" type="text" value="<?=$model[0]->Name?>" placeholder="The name of the task" required>
    <textarea name="Description" type="text" cols="80" rows="10" placeholder="Task" required><?=$model[0]->Description?></textarea>
